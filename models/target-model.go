...
type TargetDownloadPreferences struct {
	URL          string `json:"url"`
	DownloadMode string `json:"downloadMode"`
	FileExtension string `json:"fileExtension"`
	Resolution string `json:"resolution"`
	DownloadEntire string `json:"downloadEntire"`
	YtdlCommand string `json:"ytdlCommand"`
	Path string `json:"path"`
}

type TargetInformation struct {
	TargetDownloadPreferences
	LastChecked string `json:"lastChecked"`
}

func (target TargetDownloadPreferences) GetMetadata() (TargetMetadata, error) {
